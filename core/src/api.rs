...
use crate::datamodel::{tallies::Tallies, Weight};
...
pub trait PostProcessPopulation
{
...
pub trait PostProcessReaderInfo {
...
use std::fmt::Debug;
pub trait PostProcessApi: Send + Sync +Debug+PostProcessReader + PostProcessReaderInfo+PostProcessPopulation+ModelEstimator {}
impl<T:Send + Sync +Debug+PostProcessReader + PostProcessReaderInfo+PostProcessPopulation+ModelEstimator > PostProcessApi for T {}
